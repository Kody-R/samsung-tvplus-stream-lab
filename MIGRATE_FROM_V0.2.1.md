# Migrating from v0.2.1 to v0.2.3

1. Push the v0.2.3 source to GitHub.
2. Wait for GitHub Actions to publish `ghcr.io/kody-r/samsung-tvplus-stream-lab:latest` and `:0.2.3`.
